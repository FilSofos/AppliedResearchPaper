...
Viscosity and thermal conductivity literature data (from https://doi.org/10.1063/1.3253152) is combined with newly-extracted MD simualtion data and a number of ML algorithms are trained. The MD/ML framework can be run in parallel.
